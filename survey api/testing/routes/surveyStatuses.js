...
//         var query =
//             "CREATE TABLE SurveyStatus (Id VarChar(255) PRIMARY KEY, SurveyId VarChar(255), IsActive VarChar(255));";
...
//             .query(
//                 "INSERT INTO Survey (SurveyId,SurveyName,CreatedBy) VALUES (@SurveyId,@SurveyName,@CreatedBy)",
//                 function(err, result) {
//                     if (err) {
//                         console.log(err);
//                     }
